...
const CurrentStateAnalysisWizard: React.FC<CurrentStateAnalysisProps> = ({ onComplete, onStartFutureAnalysis }) => {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Current State Analysis</h1>
          <p className="text-gray-600">Comprehensive assessment of your business process</p>
        </div>
